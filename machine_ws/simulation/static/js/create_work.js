...
const createTask=(nWorks,nMachines)=>{
	if(nWorks ==0 || nMachines==0){
		...
		createFormElements(nWorks,nMachines)
	}
}
const createFormElements =(nWorks, nMachines)=>{
	...
	createInputsTask(nWorks, nMachines, form);
...
const createInputsTask=(nWorks, nMachines, form)=>{
